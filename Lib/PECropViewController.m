...
- (void)commonInit {
	...
	titleLabel.font = [UIFont fontWithName:@"ProximaNova-Regular" size:18.0];
	titleLabel.text = NSLocalizedString(@"Adjust photo", nil);
	titleLabel.textAlignment = NSTextAlignmentCenter;
	titleLabel.textColor = [UIColor colorWithRed:255.0 / 255.0 green:80.0 / 255.0 blue:0.0 alpha:1.0];
...
- (void)viewDidLoad {
	...
	NSDictionary *const itemTitleAppearance = @{ NSFontAttributeName: [UIFont fontWithName:@"ProximaNova-Regular" size:18.0], NSForegroundColorAttributeName: [UIColor colorWithRed:255.0 / 255.0 green:80.0 / 255.0 blue:0.0 alpha:1.0] };

	self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(cancel:)];
	[self.navigationItem.rightBarButtonItem setTitleTextAttributes:itemTitleAppearance forState:UIControlStateNormal];


	self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(done:)];
	[self.navigationItem.rightBarButtonItem setTitleTextAttributes:itemTitleAppearance forState:UIControlStateNormal];

	self.navigationController.navigationBar.backgroundColor = [UIColor colorWithRed:255.0 / 255.0 green:80.0 / 255.0 blue:0.0 alpha:1.0];
...
- (void)viewDidAppear:(BOOL)animated {
	...
	self.navigationController.navigationBar.tintColor = [UIColor colorWithRed:255.0 / 255.0 green:80.0 / 255.0 blue:0.0 alpha:1.0];
}
...
- (void)setCropRect:(CGRect)cropRect {
	...
	NSLog(@"%@", NSStringFromCGRect(cropViewCropRect));
}
